...
public class PrefsHelper {
    ...
    public static final String PREF_SESSION_EXPIRE_DATE = "session_expiration_date";

    public static final String PREF_IS_SEND_CHACKED = "is_send_chacked";


    public static final String PREF_CROUTONS_DISABLED = "pref_croutons_disabled";

    public static final String PREF_CONVERSATION_TONE = "conversation_tone";
