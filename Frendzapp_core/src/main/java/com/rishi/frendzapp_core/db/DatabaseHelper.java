...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String DB_NAME = "frndz.db";
    ...
    private void createUserTable(SQLiteDatabase db) {
        ...
        userTableFields
                ...
                .append(UserTable.Cols.DOB).append(" TEXT, ")
                .append(UserTable.Cols.CITY).append(" TEXT, ")
                .append(UserTable.Cols.STATUS).append(" TEXT, ")
                .append(UserTable.Cols.AUDIO_STATUS).append(" TEXT, ")
