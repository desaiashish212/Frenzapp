...
public class QBServiceConsts {
    ...
    public static final String EXTRA_FRIEND_DIFF = "differenc";
    public static final String EXTRA_FRIEND_TURNS = "turns";
     ...
     * By default we are loading in {@link com.rishi.frendzapp_core.qb.commands.QBLoadDialogMessagesCommand}
