...
public class QBImportFriendsCommand extends ServiceCommand {
    ...
    public static void start(Context context, List<String> friendsContactsList) {
    ...
    protected Bundle perform(Bundle extras) throws QBResponseException {
      ...
      //          QBServiceConsts.EXTRA_FRIENDS_FACEBOOK);
        ...
        //friendsContactsList.add("desaiashish212@gmail.com");
...
*/
        if (!friendsContactsList.isEmpty()) {
            realFriendsContactsList = QBUsers.getUsersByLogins(friendsContactsList, requestBuilder, params);
        }

        List<Integer> realFriendsList = getSelectedUsersList(
