 ...
 */
public class AccountDeleteActivity extends BaseLogeableActivity implements InitInterface {
    private TextView tv_country_code;
    private EditText et_mobile_number;
    private Button btn_delet_account;
    private String country;
    private String countruCode;
    private String mPhoneNumber;

    public static void start(Context context) {
        Intent intent = new Intent(context, AccountDeleteActivity.class);
...
//                WindowManager.LayoutParams.FLAG_SECURE);
        ...
        init();
        setListener();
        tv_country_code.setText(countruCode);
    ...
    @Override
    public void init() {
        tv_country_code=(TextView)findViewById(R.id.txt_country_code);
        et_mobile_number=(EditText)findViewById(R.id.et_mobileNo);
    ...
    public void setListener() {
        ...
        tv_country_code.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(AccountDeleteActivity.this,"You clicked on the Country code",Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btn_delet_account.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String EnteredMob="+91"+Mobile;
                PrefManager pref = new PrefManager(getApplicationContext());
                HashMap<String, String> profile = pref.getUserDetails();

                String DB_mobileNumber = profile.get("mobile");
                if(Mobile.equals(""))
                {
                    Toast.makeText(AccountDeleteActivity.this,"please enter the mobile number",Toast.LENGTH_SHORT).show();

                }

                else if(DB_mobileNumber.equals("+91"+Mobile))
                {
                    Intent inti=new Intent(AccountDeleteActivity.this,AccountDeleteOneActivity.class);
                    inti.putExtra("DB_mobileNumber",DB_mobileNumber);
                    startActivity(inti);
                    finish();
                }
                else {
                    Toast.makeText(AccountDeleteActivity.this,"The phone number you have entered doesn't match your account's",Toast.LENGTH_SHORT).show();
                }
    ...
    // this code is used for the different country code
