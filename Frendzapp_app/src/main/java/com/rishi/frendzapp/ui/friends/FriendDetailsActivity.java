...
public class FriendDetailsActivity extends BaseLogeableActivity {
    ...
    private void initUI() {
        ...
        emailView = _findViewById(R.id.email_relativelayout);
        dobTextView = _findViewById(R.id.dob_textview);
        dobView = _findViewById(R.id.dob_relativelayout);
        cityTextView = _findViewById(R.id.city_textview);
        cityView = _findViewById(R.id.city_relativelayout);
        ...
        if (checkFriendStatus(user.getUserId())) {
            try {
                QBDialog existingPrivateDialog = privateChatHelper.createPrivateDialogIfNotExist(
                        user.getUserId());
                PrivateDialogActivity.start(FriendDetailsActivity.this, user, existingPrivateDialog,null);
