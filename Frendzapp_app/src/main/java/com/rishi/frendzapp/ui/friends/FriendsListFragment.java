...
public class FriendsListFragment extends BaseFragment implements SearchView.OnQueryTextListener, AbsListView.OnScrollListener {
    ...
    private List<User> inviteFriendList;
    private List<String> inviteNumberList;
    private List<String> inviteNameList;
    private List<FriendGroup> friendGroupList;
    private FriendGroup friendGroupAllFriends;
    private FriendGroup inviteGroupAllFriends;
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        menu.findItem(R.id.action_add_contact).setVisible(QBConnectivityManager.isConnectionExists());
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        inviteFriendList = new ArrayList<User>();
        inviteNumberList = new ArrayList<String>();
    ...
    private void initInviteFriends(){
        getAllContacts(baseActivity.getContentResolver());
    }
    ...
    public boolean isQBuseruserPresent(String phoneNumber) {

        for(int i=0;i<friendList.size();i++)
        {
            if(phoneNumber.equals(friendList.get(i).getLogin()))
            {
                return  true;
            }
        }
    ...
    private void initFriendAdapter() {
        sortLists();
        inviteGroupAllFriends = new FriendGroup(FriendGroup.GROUP_POSITION_MY_CONTACTS, resources.getString(
                R.string.frl_column_header_name_invite_friend));
        inviteGroupAllFriends.setUserList(new ArrayList<User>(inviteNameList.size()));
        inviteGroupAllFriends.addUserList(inviteFriendList);
        friendGroupList.add(inviteGroupAllFriends);
