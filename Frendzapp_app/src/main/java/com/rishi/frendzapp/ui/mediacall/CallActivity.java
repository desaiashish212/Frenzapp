...
import com.rishi.frendzapp.ui.videocall.VideoCallFragment;
import com.rishi.frendzapp.ui.voicecall.VoiceCallFragment;
 ...
 * from {@link com.rishi.frendzapp.ui.chats.PrivateDialogActivity} and {@link com.rishi.frendzapp.ui.friends.FriendDetailsActivity}
...
public class CallActivity extends BaseLogeableActivity implements IncomingCallActionsListener,
    ...
    private void stopCall() {
        ...
        if (QBRTCClient.isInitiated()) {
         //   QBRTCClient.getInstance(this).close(true);
        }
