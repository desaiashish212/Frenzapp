...
public class FriendsListCallAdapter extends BaseExpandableListAdapter {
    ...
    public FriendsListCallAdapter(Context context, FriendOperationListener friendOperationListener,
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View view,
        ...
        if (view == null) {
            view = layoutInflater.inflate(R.layout.list_item_call, null);
